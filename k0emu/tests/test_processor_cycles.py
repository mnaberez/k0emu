...
class CycleCountTests(unittest.TestCase):
    ...
    def test_reset_clears_cycle_count(self):
        ...
        proc.step()
        self.assertNotEqual(proc.cycle_count, 0)
        proc.reset()
        self.assertEqual(proc.cycle_count, 0)
    ...
    def test_cycles_accumulate(self):
        ...
        proc.step()
        proc.step()
        self.assertEqual(proc.cycle_count, 6)
    ...
    def test_cycles_00_nop(self):
        ...
        proc.step()
        self.assertEqual(proc.cycle_count, 2)
    ...
    def test_cycles_02_movw_ax_addr16p_internal_ram(self):
        ...
        proc.step()
        self.assertEqual(proc.cycle_count, 10)  # addr=FE00 (internal RAM)
    ...
    def test_cycles_02_movw_ax_addr16p_not_internal_ram(self):
        ...
        proc.step()
        self.assertEqual(proc.cycle_count, 12)  # addr=1000 (ROM)
    ...
    def test_cycles_03_movw_addr16p_ax_internal_ram(self):
        ...
        proc.step()
        self.assertEqual(proc.cycle_count, 10)
    ...
    def test_cycles_03_movw_addr16p_ax_not_internal_ram(self):
        ...
        proc.step()
        self.assertEqual(proc.cycle_count, 12)
    ...
    def test_cycles_04_dbnz_saddr_internal_ram(self):
        ...
        proc.step()
        self.assertEqual(proc.cycle_count, 8)
    ...
    def test_cycles_05_xch_a_de_internal_ram(self):
        ...
        proc.step()
        self.assertEqual(proc.cycle_count, 4)
    ...
    def test_cycles_08_add_a_addr16_not_internal_ram(self):
        ...
        proc.step()
        self.assertEqual(proc.cycle_count, 9)
    ...
    def test_cycles_0a_set1_saddr_internal_ram(self):
        ...
        proc.step()
        self.assertEqual(proc.cycle_count, 4)  # saddr=FE20
    ...
    def test_cycles_0a_set1_psw_bit_sfr(self):
        ...
        proc.step()
        self.assertEqual(proc.cycle_count, 6)  # saddr=FF1E (PSW)
    ...
    def test_cycles_0c_callf(self):
        ...
        proc.step()
        self.assertEqual(proc.cycle_count, 5)
    ...
    def test_cycles_0e_add_a_saddr_sfr(self):
        ...
        proc.step()
        self.assertEqual(proc.cycle_count, 5)  # PSW at FF1E
    ...
    def test_cycles_11_mov_psw_imm_sfr(self):
        ...
        proc.step()
        self.assertEqual(proc.cycle_count, 7)
    ...
    def test_cycles_30_xch_a_r(self):
        ...
        proc.step()
        self.assertEqual(proc.cycle_count, 2)  # xch a,x
    ...
    def test_cycles_40_inc_r(self):
        ...
        proc.step()
        self.assertEqual(proc.cycle_count, 2)  # inc x
    ...
    def test_cycles_50_dec_r(self):
        ...
        proc.step()
        self.assertEqual(proc.cycle_count, 2)  # dec x
    ...
    def test_cycles_60_mov_a_r(self):
        ...
        proc.step()
        self.assertEqual(proc.cycle_count, 2)  # mov a,x
    ...
    def test_cycles_70_mov_r_a(self):
        ...
        proc.step()
        self.assertEqual(proc.cycle_count, 2)  # mov c,a
    ...
    def test_cycles_80_incw_rp(self):
        ...
        proc.step()
        self.assertEqual(proc.cycle_count, 4)  # incw ax
    ...
    def test_cycles_81_inc_saddr_sfr(self):
        ...
        proc.step()
        self.assertEqual(proc.cycle_count, 6)  # saddr=FF00
    ...
    def test_cycles_83_xch_a_saddr_sfr(self):
        ...
        proc.step()
        self.assertEqual(proc.cycle_count, 6)  # PSW
    ...
    def test_cycles_89_movw_ax_saddrp_sfr(self):
        ...
        proc.step()
        self.assertEqual(proc.cycle_count, 8)  # SP at FF1C
    ...
    def test_cycles_90_decw_rp(self):
        ...
        proc.step()
        self.assertEqual(proc.cycle_count, 4)  # decw ax
    ...
    def test_cycles_99_movw_saddrp_ax_sfr(self):
        ...
        proc.step()
        self.assertEqual(proc.cycle_count, 8)  # SP
    ...
    def test_cycles_a0_mov_r_imm(self):
        ...
        proc.step()
        self.assertEqual(proc.cycle_count, 4)  # mov x,#42h
    ...
    def test_cycles_b0_pop_rp(self):
        ...
        proc.step()
        self.assertEqual(proc.cycle_count, 4)  # pop ax
    ...
    def test_cycles_b1_push_rp(self):
        ...
        proc.step()
        self.assertEqual(proc.cycle_count, 4)  # push ax
    ...
    def test_cycles_c2_movw_ax_rp(self):
        ...
        proc.step()
        self.assertEqual(proc.cycle_count, 4)  # movw ax,bc
    ...
    def test_cycles_d2_movw_rp_ax(self):
        ...
        proc.step()
        self.assertEqual(proc.cycle_count, 4)  # movw bc,ax
    ...
    def test_cycles_e2_xchw_ax_rp(self):
        ...
        proc.step()
        self.assertEqual(proc.cycle_count, 4)  # xchw ax,bc
    ...
    def test_cycles_31_03_bf_saddr_sfr(self):
        ...
        proc.step()
        self.assertEqual(proc.cycle_count, 11)
    ...
    def test_cycles_31_82_divuw(self):
        ...
        proc.step()
        self.assertEqual(proc.cycle_count, 25)
    ...
    def test_cycles_31_88_mulu(self):
        ...
        proc.step()
        self.assertEqual(proc.cycle_count, 16)
    ...
    def test_cycles_71_01_mov1_saddr_cy_sfr(self):
        ...
        proc.step()
        self.assertEqual(proc.cycle_count, 8)  # PSW
