...
from k0emu.devices import (BaseDevice, MemoryDevice, I2CDevice,
                           I2CTargetStub, EepromDevice,
...
class I2CDeviceBasicTests(unittest.TestCase):

    def test_name(self):
        i2c = I2CDevice("i2c")
        self.assertEqual(i2c.name, "i2c")
    ...
    def test_iic0_write_read(self):
        i2c = I2CDevice("i2c")
        i2c.write(I2CDevice.IIC0, 0x42)
        self.assertEqual(i2c.read(I2CDevice.IIC0), 0x42)

    def test_iiccl0_write_read(self):
        i2c = I2CDevice("i2c")
        i2c.write(I2CDevice.IICCL0, 0x0C)
        self.assertEqual(i2c.read(I2CDevice.IICCL0), 0x0C)

    def test_disable_clears_status(self):
        i2c = I2CDevice("i2c")
        i2c.write(I2CDevice.IICC0, I2CDevice.IICE0)
        i2c.write(I2CDevice.IICS0, 0xFF)
        i2c.write(I2CDevice.IICC0, 0x00)  # disable
        self.assertEqual(i2c.read(I2CDevice.IICS0), 0x00)


class I2CMasterWriteTests(unittest.TestCase):
    """Test master write: start -> address+W -> data bytes -> stop."""
    ...
    def test_start_sets_iicif0(self):
        ...
        i2c.write(I2CDevice.IIC0, 0xA0)
        # Enable + start
        i2c.write(I2CDevice.IICC0, I2CDevice.IICE0 | I2CDevice.WTIM0
                  | I2CDevice.ACKE0 | I2CDevice.STT0)
    ...
    def test_start_sets_msts0_and_trc0(self):
        ...
        i2c.write(I2CDevice.IICC0, I2CDevice.IICE0 | I2CDevice.WTIM0
                  | I2CDevice.ACKE0 | I2CDevice.STT0)
        iics0 = i2c.read(I2CDevice.IICS0)
        self.assertTrue(iics0 & I2CDevice.MSTS0)  # master mode
        self.assertTrue(iics0 & I2CDevice.TRC0)    # transmit mode
    ...
    def test_start_sets_ackd0_when_target_present(self):
        ...
        i2c.write(I2CDevice.IICC0, I2CDevice.IICE0 | I2CDevice.WTIM0
                  | I2CDevice.ACKE0 | I2CDevice.STT0)
        self.assertTrue(i2c.read(I2CDevice.IICS0) & I2CDevice.ACKD0)
    ...
    def test_start_clears_ackd0_when_no_target(self):
        ...
        i2c.write(I2CDevice.IICC0, I2CDevice.IICE0 | I2CDevice.WTIM0
                  | I2CDevice.ACKE0 | I2CDevice.STT0)
        self.assertFalse(i2c.read(I2CDevice.IICS0) & I2CDevice.ACKD0)
    ...
    def test_start_clears_stt0(self):
        ...
        i2c.write(I2CDevice.IICC0, I2CDevice.IICE0 | I2CDevice.WTIM0
                  | I2CDevice.ACKE0 | I2CDevice.STT0)
        self.assertFalse(i2c.read(I2CDevice.IICC0) & I2CDevice.STT0)
    ...
    def test_stop_sets_std0(self):
        ...
        # Stop
        i2c.write(I2CDevice.IICC0, I2CDevice.IICE0 | I2CDevice.WTIM0
                  | I2CDevice.ACKE0 | I2CDevice.SPT0)
        self.assertTrue(i2c.read(I2CDevice.IICS0) & I2CDevice.STD0)
...
class I2CMasterReadTests(unittest.TestCase):
    """Test master read: start -> address+R -> read bytes -> stop."""
    ...
    def test_read_byte_from_target(self):
        i2c, intc, bus = _make_i2c_on_bus()
        stub = I2CTargetStub(read_value=0x42)
        i2c.add_target(0x50, stub)
        # Start with read bit set (0xA1)
        i2c.write(I2CDevice.IIC0, 0xA1)
        i2c.write(I2CDevice.IICC0, I2CDevice.IICE0 | I2CDevice.WTIM0
                  | I2CDevice.ACKE0 | I2CDevice.STT0)
        self._clear_iicif0(intc)
        # Trigger read by writing dummy byte to IIC0
        i2c.write(I2CDevice.IIC0, 0xFF)
        self.assertEqual(i2c.read(I2CDevice.IIC0), 0x42)
        self.assertTrue(self._iicif0_set(intc))
...
class EepromWriteReadTests(unittest.TestCase):
    ...
    def _start(self, i2c, intc, addr_byte):
        i2c.write(I2CDevice.IIC0, addr_byte)
        i2c.write(I2CDevice.IICC0, I2CDevice.IICE0 | I2CDevice.WTIM0
                  | I2CDevice.ACKE0 | I2CDevice.STT0)
        self._clear_iicif0(intc)

    def _write_byte(self, i2c, intc, data):
        i2c.write(I2CDevice.IIC0, data)
        self._clear_iicif0(intc)

    def _read_byte(self, i2c, intc):
        i2c.write(I2CDevice.IIC0, 0xFF)
        val = i2c.read(I2CDevice.IIC0)
        self._clear_iicif0(intc)
        return val

    def _stop(self, i2c, intc):
        iicc0 = i2c.read(I2CDevice.IICC0)
        i2c.write(I2CDevice.IICC0, (iicc0 & ~I2CDevice.STT0) | I2CDevice.SPT0)
        self._clear_iicif0(intc)
