...
class ProcessorTests(unittest.TestCase):
    ...
    def test_31_07_bf_sfr_bit0_branches_if_clear(self):
        ...
        proc.write_memory(0, code)
        proc.write_psw(0x55)
        proc.memory[0x0fffe] = 0b11111110
        proc.step()
    ...
    def test_31_17_bf_sfr_bit1_branches_if_clear(self):
        ...
        proc.write_memory(0, code)
        proc.write_psw(0x55)
        proc.memory[0x0fffe] = 0b11111101
        proc.step()
        self.assertEqual(proc.pc, 0x24) # branch taken
        self.assertEqual(proc.read_psw(), 0x55) # unchanged
    ...
    def test_31_27_bf_sfr_bit2_branches_if_clear(self):
        ...
        proc.write_memory(0, code)
        proc.write_psw(0x55)
        proc.memory[0x0fffe] = 0b11111011
        proc.step()
        self.assertEqual(proc.pc, 0x24) # branch taken
        self.assertEqual(proc.read_psw(), 0x55) # unchanged
    ...
    def test_31_37_bf_sfr_bit3_branches_if_clear(self):
        ...
        proc.write_memory(0, code)
        proc.write_psw(0x55)
        proc.memory[0x0fffe] = 0b11110111
        proc.step()
        self.assertEqual(proc.pc, 0x24) # branch taken
        self.assertEqual(proc.read_psw(), 0x55) # unchanged
    ...
    def test_31_47_bf_sfr_bit4_branches_if_clear(self):
        ...
        proc.write_memory(0, code)
        proc.write_psw(0x55)
        proc.memory[0x0fffe] = 0b11101111
        proc.step()
        self.assertEqual(proc.pc, 0x24) # branch taken
        self.assertEqual(proc.read_psw(), 0x55) # unchanged
    ...
    def test_31_57_bf_sfr_bit5_branches_if_clear(self):
        ...
        proc.write_memory(0, code)
        proc.write_psw(0x55)
        proc.memory[0x0fffe] = 0b11011111
        proc.step()
        self.assertEqual(proc.pc, 0x24) # branch taken
        self.assertEqual(proc.read_psw(), 0x55) # unchanged
    ...
    def test_31_67_bf_sfr_bit6_branches_if_clear(self):
        ...
        proc.write_memory(0, code)
        proc.write_psw(0x55)
        proc.memory[0x0fffe] = 0b10111111
        proc.step()
        self.assertEqual(proc.pc, 0x24) # branch taken
        self.assertEqual(proc.read_psw(), 0x55) # unchanged
    ...
    def test_31_77_bf_sfr_bit7_branches_if_clear(self):
        ...
        proc.write_memory(0, code)
        proc.write_psw(0x55)
        proc.memory[0x0fffe] = 0b01111111
        proc.step()
        self.assertEqual(proc.pc, 0x24) # branch taken
        self.assertEqual(proc.read_psw(), 0x55) # unchanged
    ...
    def test_31_03_bf_psw_bit0_branches_if_clear(self):
        ...
        self.assertEqual(proc.read_psw(), 0b11111110) # unchanged
    ...
    def test_31_13_bf_psw_bit1_branches_if_clear(self):
        ...
        proc.step()
        self.assertEqual(proc.pc, 0x34) # branch taken
        self.assertEqual(proc.read_psw(), 0b11111101) # unchanged
    ...
    def test_31_23_bf_psw_bit2_doesnt_branch_if_set(self):
        proc = Processor()
        code = [0x31, 0x23, 0x1e, 0x30]
        proc.write_memory(0, code)
        proc.write_psw(0b00000100)
    ...
    def test_31_33_bf_psw_bit3_branches_if_clear(self):
        ...
        proc.step()
        self.assertEqual(proc.pc, 0x34) # branch taken
        self.assertEqual(proc.read_psw(), 0b11110111) # unchanged
    ...
    def test_31_43_bf_psw_bit4_branches_if_clear(self):
        ...
        proc.step()
        self.assertEqual(proc.pc, 0x34) # branch taken
        self.assertEqual(proc.read_psw(), 0b11101111) # unchanged
    ...
    def test_31_53_bf_psw_bit5_branches_if_clear(self):
        ...
        proc.step()
        self.assertEqual(proc.pc, 0x34) # branch taken
        self.assertEqual(proc.read_psw(), 0b11011111) # unchanged
    ...
    def test_31_63_bf_psw_bit6_branches_if_clear(self):
        ...
        proc.step()
        self.assertEqual(proc.pc, 0x34) # branch taken
        self.assertEqual(proc.read_psw(), 0b10111111) # unchanged
    ...
    def test_31_73_bf_psw_bit7_branches_if_clear(self):
        ...
        proc.step()
        self.assertEqual(proc.pc, 0x34) # branch taken
        self.assertEqual(proc.read_psw(), 0b01111111) # unchanged
    ...
    def test_ce_movw_ax_addr16p(self):
        ...
        code = [0x02, 0xce, 0xab]
        proc.write_memory(0, code)
        proc.write_memory(0xabce, [0xcd, 0xab])
        proc.write_gp_regpair(RegisterPairs.AX, 0)
        proc.step()
        self.assertEqual(proc.pc, len(code))
        self.assertEqual(proc.read_gp_regpair(RegisterPairs.AX), 0xabcd)
    ...
    def test_03_movw_addr16p_ax(self):
        ...
        code = [0x03, 0xce, 0xab]
        proc.write_memory(0, code)
        proc.write_memory(0xabce, [0, 0])
        proc.write_gp_regpair(RegisterPairs.AX, 0xabcd)
        proc.step()
        self.assertEqual(proc.pc, len(code))
        self.assertEqual(proc.memory[0xabce], 0xcd)
    ...
    # xor1 cy,[hl].0              ;71 87
    def test_71_87_xor_cy_hl_bit0_0_xor_1(self):
        proc = Processor()
        code = [0x71, 0x87]
        proc.write_memory(0, code)
        proc.write_psw(0)
    ...
    # xor1 cy,[hl].0              ;71 87
    def test_71_87_xor_cy_hl_bit0_1_xor_1(self):
        proc = Processor()
        code = [0x71, 0x87]
        proc.write_memory(0, code)
        proc.write_psw(Flags.CY)
    ...
    # xor1 cy,[hl].1              ;71 97
    def test_71_97_xor_cy_hl_bit1_0_xor_1(self):
        proc = Processor()
        code = [0x71, 0x97]
        proc.write_memory(0, code)
        proc.write_psw(0)
    ...
    # xor1 cy,[hl].1              ;71 97
    def test_71_97_xor_cy_hl_bit1_1_xor_1(self):
        proc = Processor()
        code = [0x71, 0x97]
        proc.write_memory(0, code)
        proc.write_psw(Flags.CY)
    ...
    # xor1 cy,[hl].2              ;71 a7
    def test_71_a7_xor_cy_hl_bit2_0_xor_1(self):
        proc = Processor()
        code = [0x71, 0xa7]
        proc.write_memory(0, code)
        proc.write_psw(0)
    ...
    # xor1 cy,[hl].2              ;71 a7
    def test_71_a7_xor_cy_hl_bit2_1_xor_1(self):
        proc = Processor()
        code = [0x71, 0xa7]
        proc.write_memory(0, code)
        proc.write_psw(Flags.CY)
    ...
    # xor1 cy,[hl].3              ;71 b7
    def test_71_b7_xor_cy_hl_bit3_0_xor_1(self):
        proc = Processor()
        code = [0x71, 0xb7]
        proc.write_memory(0, code)
        proc.write_psw(0)
    ...
    # xor1 cy,[hl].3              ;71 b7
    def test_71_b7_xor_cy_hl_bit3_1_xor_1(self):
        proc = Processor()
        code = [0x71, 0xb7]
        proc.write_memory(0, code)
        proc.write_psw(Flags.CY)
    ...
    # xor1 cy,[hl].4              ;71 c7
    def test_71_c7_xor_cy_hl_bit4_0_xor_1(self):
        proc = Processor()
        code = [0x71, 0xc7]
        proc.write_memory(0, code)
        proc.write_psw(0)
    ...
    # xor1 cy,[hl].4              ;71 c7
    def test_71_c7_xor_cy_hl_bit4_1_xor_1(self):
        proc = Processor()
        code = [0x71, 0xc7]
        proc.write_memory(0, code)
        proc.write_psw(Flags.CY)
    ...
    # xor1 cy,[hl].5              ;71 d7
    def test_71_d7_xor_cy_hl_bit5_0_xor_1(self):
        proc = Processor()
        code = [0x71, 0xd7]
        proc.write_memory(0, code)
        proc.write_psw(0)
    ...
    # xor1 cy,[hl].5              ;71 d7
    def test_71_d7_xor_cy_hl_bit5_1_xor_1(self):
        proc = Processor()
        code = [0x71, 0xd7]
        proc.write_memory(0, code)
        proc.write_psw(Flags.CY)
    ...
    # xor1 cy,[hl].6              ;71 e7
    def test_71_e7_xor_cy_hl_bit6_0_xor_1(self):
        proc = Processor()
        code = [0x71, 0xe7]
        proc.write_memory(0, code)
        proc.write_psw(0)
    ...
    # xor1 cy,[hl].6              ;71 e7
    def test_71_e7_xor_cy_hl_bit6_1_xor_1(self):
        proc = Processor()
        code = [0x71, 0xe7]
        proc.write_memory(0, code)
        proc.write_psw(Flags.CY)
    ...
    # xor1 cy,[hl].7              ;71 f7
    def test_71_f7_xor_cy_hl_bit7_0_xor_1(self):
        proc = Processor()
        code = [0x71, 0xf7]
        proc.write_memory(0, code)
        proc.write_psw(0)
    ...
    # xor1 cy,[hl].7              ;71 f7
    def test_71_f7_xor_cy_hl_bit7_1_xor_1(self):
        proc = Processor()
        code = [0x71, 0xf7]
        proc.write_memory(0, code)
        proc.write_psw(Flags.CY)
    ...
    def test_71_0f_xor_cy_sfr_bit0_0_xor_1(self):
        proc = Processor()
        code = [0x71, 0x0f, 0xfe]
        proc.write_memory(0, code)
        proc.write_psw(0)
    ...
    # xor1 cy,0fffeh.0            ;71 0f fe       sfr
    def test_71_0f_xor_cy_sfr_bit0_1_xor_1(self):
        proc = Processor()
        code = [0x71, 0x0f, 0xfe]
        proc.write_memory(0, code)
        proc.write_psw(Flags.CY)
    ...
    def test_71_1f_xor_cy_sfr_bit1_0_xor_1(self):
        proc = Processor()
        code = [0x71, 0x1f, 0xfe]
        proc.write_memory(0, code)
        proc.write_psw(0)
    ...
    def test_71_1f_xor_cy_sfr_bit1_1_xor_1(self):
        proc = Processor()
        code = [0x71, 0x1f, 0xfe]
        proc.write_memory(0, code)
        proc.write_psw(Flags.CY)
    ...
    def test_71_2f_xor_cy_sfr_bit2_0_xor_1(self):
        proc = Processor()
        code = [0x71, 0x2f, 0xfe]
        proc.write_memory(0, code)
        proc.write_psw(0)
    ...
    # xor1 cy,0fffeh.2            ;71 2f fe       sfr
    def test_71_2f_xor_cy_sfr_bit2_1_xor_1(self):
        proc = Processor()
        code = [0x71, 0x2f, 0xfe]
        proc.write_memory(0, code)
        proc.write_psw(Flags.CY)
    ...
    def test_71_3f_xor_cy_sfr_bit3_0_xor_1(self):
        proc = Processor()
        code = [0x71, 0x3f, 0xfe]
        proc.write_memory(0, code)
        proc.write_psw(0)
    ...
    # xor1 cy,0fffeh.3            ;71 3f fe       sfr
    def test_71_3f_xor_cy_sfr_bit3_1_xor_1(self):
        proc = Processor()
        code = [0x71, 0x3f, 0xfe]
        proc.write_memory(0, code)
        proc.write_psw(Flags.CY)
    ...
    def test_71_4f_xor_cy_sfr_bit4_0_xor_1(self):
        proc = Processor()
        code = [0x71, 0x4f, 0xfe]
        proc.write_memory(0, code)
        proc.write_psw(0)
    ...
    # xor1 cy,0fffeh.4            ;71 4f fe       sfr
    def test_71_4f_xor_cy_sfr_bit4_1_xor_1(self):
        proc = Processor()
        code = [0x71, 0x4f, 0xfe]
        proc.write_memory(0, code)
        proc.write_psw(Flags.CY)
    ...
    def test_71_5f_xor_cy_sfr_bit5_0_xor_1(self):
        proc = Processor()
        code = [0x71, 0x5f, 0xfe]
        proc.write_memory(0, code)
        proc.write_psw(0)
    ...
    # xor1 cy,0fffeh.5            ;71 5f fe       sfr
    def test_71_5f_xor_cy_sfr_bit5_1_xor_1(self):
        proc = Processor()
        code = [0x71, 0x5f, 0xfe]
        proc.write_memory(0, code)
        proc.write_psw(Flags.CY)
    ...
    def test_71_6f_xor_cy_sfr_bit6_0_xor_1(self):
        proc = Processor()
        code = [0x71, 0x6f, 0xfe]
        proc.write_memory(0, code)
        proc.write_psw(0)
    ...
    # xor1 cy,0fffeh.6            ;71 6f fe       sfr
    def test_71_6f_xor_cy_sfr_bit6_1_xor_1(self):
        proc = Processor()
        code = [0x71, 0x6f, 0xfe]
        proc.write_memory(0, code)
        proc.write_psw(Flags.CY)
    ...
    def test_71_7f_xor_cy_sfr_bit7_0_xor_1(self):
        proc = Processor()
        code = [0x71, 0x7f, 0xfe]
        proc.write_memory(0, code)
        proc.write_psw(0)
    ...
    # xor1 cy,0fffeh.7            ;71 7f fe       sfr
    def test_71_7f_xor_cy_sfr_bit7_1_xor_1(self):
        proc = Processor()
        code = [0x71, 0x7f, 0xfe]
        proc.write_memory(0, code)
        proc.write_psw(Flags.CY)
    ...
    def test_71_07_xor_cy_saddr_bit0_0_xor_1(self):
        proc = Processor()
        code = [0x71, 0x07, 0x20]
        proc.write_memory(0, code)
        proc.write_psw(0)
    ...
    # xor1 cy,0fe20h.0            ;71 07 20       saddr
    def test_71_07_xor_cy_saddr_bit0_1_xor_1(self):
        proc = Processor()
        code = [0x71, 0x07, 0x20]
        proc.write_memory(0, code)
        proc.write_psw(Flags.CY)
    ...
    def test_71_17_xor_cy_saddr_bit1_0_xor_1(self):
        proc = Processor()
        code = [0x71, 0x17, 0x20]
        proc.write_memory(0, code)
        proc.write_psw(0)
    ...
    # xor1 cy,0fe20h.1            ;71 17 20       saddr
    def test_71_17_xor_cy_saddr_bit1_1_xor_1(self):
        proc = Processor()
        code = [0x71, 0x17, 0x20]
        proc.write_memory(0, code)
        proc.write_psw(Flags.CY)
    ...
    def test_71_27_xor_cy_saddr_bit2_0_xor_1(self):
        proc = Processor()
        code = [0x71, 0x27, 0x20]
        proc.write_memory(0, code)
        proc.write_psw(0)
    ...
    # xor1 cy,0fe20h.2            ;71 27 20       saddr
    def test_71_27_xor_cy_saddr_bit2_1_xor_1(self):
        proc = Processor()
        code = [0x71, 0x27, 0x20]
        proc.write_memory(0, code)
        proc.write_psw(Flags.CY)
    ...
    def test_71_37_xor_cy_saddr_bit3_0_xor_1(self):
        proc = Processor()
        code = [0x71, 0x37, 0x20]
        proc.write_memory(0, code)
        proc.write_psw(0)
    ...
    # xor1 cy,0fe20h.3            ;71 37 20       saddr
    def test_71_37_xor_cy_saddr_bit3_1_xor_1(self):
        proc = Processor()
        code = [0x71, 0x37, 0x20]
        proc.write_memory(0, code)
        proc.write_psw(Flags.CY)
    ...
    def test_71_47_xor_cy_saddr_bit4_0_xor_1(self):
        proc = Processor()
        code = [0x71, 0x47, 0x20]
        proc.write_memory(0, code)
        proc.write_psw(0)
    ...
    # xor1 cy,0fe20h.4            ;71 47 20       saddr
    def test_71_47_xor_cy_saddr_bit4_1_xor_1(self):
        proc = Processor()
        code = [0x71, 0x47, 0x20]
        proc.write_memory(0, code)
        proc.write_psw(Flags.CY)
    ...
    def test_71_57_xor_cy_saddr_bit5_0_xor_1(self):
        proc = Processor()
        code = [0x71, 0x57, 0x20]
        proc.write_memory(0, code)
        proc.write_psw(0)
    ...
    # xor1 cy,0fe20h.4            ;71 47 20       saddr
    def test_71_57_xor_cy_saddr_bit5_1_xor_1(self):
        proc = Processor()
        code = [0x71, 0x57, 0x20]
        proc.write_memory(0, code)
        proc.write_psw(Flags.CY)
    ...
    def test_71_67_xor_cy_saddr_bit6_0_xor_1(self):
        proc = Processor()
        code = [0x71, 0x67, 0x20]
        proc.write_memory(0, code)
        proc.write_psw(0)
    ...
    # xor1 cy,0fe20h.6            ;71 67 20       saddr
    def test_71_67_xor_cy_saddr_bit6_1_xor_1(self):
        proc = Processor()
        code = [0x71, 0x67, 0x20]
        proc.write_memory(0, code)
        proc.write_psw(Flags.CY)
    ...
    def test_71_77_xor_cy_saddr_bit7_0_xor_1(self):
        proc = Processor()
        code = [0x71, 0x77, 0x20]
        proc.write_memory(0, code)
        proc.write_psw(0)
    ...
    # xor1 cy,0fe20h.7            ;71 77 20       saddr
    def test_71_77_xor_cy_saddr_bit7_1_xor_1(self):
        proc = Processor()
        code = [0x71, 0x77, 0x20]
        proc.write_memory(0, code)
        proc.write_psw(Flags.CY)
    ...
    def test_71_07_xor_cy_psw_bit0_0_xor_0_since_bit0_is_cy(self):
        proc = Processor()
        code = [0x71, 0x07, 0x1e]
        proc.write_memory(0, code)
        proc.write_psw(0)
    ...
    # xor1 cy,psw.0               ;71 07 1e
    def test_71_07_xor_cy_psw_bit0_1_xor_1_since_bit0_is_cy(self):
        proc = Processor()
        code = [0x71, 0x07, 0x1e]
        proc.write_memory(0, code)
        proc.write_psw(Flags.CY)
    ...
    def test_71_17_xor_cy_psw_bit1_0_xor_1(self):
        proc = Processor()
        code = [0x71, 0x17, 0x1e]
        proc.write_memory(0, code)
        proc.write_psw(0b00000010)
    ...
    # xor1 cy,psw.1               ;71 17 1e
    def test_71_17_xor_cy_psw_bit1_1_xor_1(self):
        proc = Processor()
        code = [0x71, 0x17, 0x1e]
        proc.write_memory(0, code)
    ...
    def test_71_27_xor_cy_psw_bit2_0_xor_1(self):
        proc = Processor()
        code = [0x71, 0x27, 0x1e]
        proc.write_memory(0, code)
        proc.write_psw(0b00000100)
    ...
    # xor1 cy,psw.2               ;71 27 1e
    def test_71_27_xor_cy_psw_bit2_1_xor_1(self):
        proc = Processor()
        code = [0x71, 0x27, 0x1e]
        proc.write_memory(0, code)
        proc.write_psw(0b00000101)
        proc.step()
        self.assertEqual(proc.pc, len(code))
        self.assertEqual(proc.read_psw(), 0b00000100)

    # xor1 cy,psw.3               ;71 37 1e
    def test_71_37_xor_cy_psw_bit3_0_xor_1(self):
        proc = Processor()
        code = [0x71, 0x37, 0x1e]
        proc.write_memory(0, code)
        proc.write_psw(0b00001000)
    ...
    # xor1 cy,psw.3               ;71 37 1e
    def test_71_37_xor_cy_psw_bit3_1_xor_1(self):
        proc = Processor()
        code = [0x71, 0x37, 0x1e]
        proc.write_memory(0, code)
    ...
    def test_71_47_xor_cy_psw_bit4_0_xor_1(self):
        proc = Processor()
        code = [0x71, 0x47, 0x1e]
        proc.write_memory(0, code)
        proc.write_psw(0b00010000)
    ...
    # xor1 cy,psw.4               ;71 47 1e
    def test_71_47_xor_cy_psw_bit4_1_xor_1(self):
        proc = Processor()
        code = [0x71, 0x47, 0x1e]
        proc.write_memory(0, code)
    ...
    def test_71_57_xor_cy_psw_bit5_0_xor_1(self):
        proc = Processor()
        code = [0x71, 0x57, 0x1e]
        proc.write_memory(0, code)
        proc.write_psw(0b00100000)
    ...
    # xor1 cy,psw.5               ;71 57 1e
    def test_71_57_xor_cy_psw_bit5_1_xor_1(self):
        proc = Processor()
        code = [0x71, 0x57, 0x1e]
        proc.write_memory(0, code)
    ...
    def test_71_67_xor_cy_psw_bit6_0_xor_1(self):
        proc = Processor()
        code = [0x71, 0x67, 0x1e]
        proc.write_memory(0, code)
        proc.write_psw(0b01000000)
    ...
    # xor1 cy,psw.6               ;71 67 1e
    def test_71_67_xor_cy_psw_bit6_1_xor_1(self):
        proc = Processor()
        code = [0x71, 0x67, 0x1e]
        proc.write_memory(0, code)
    ...
    def test_71_77_xor_cy_psw_bit7_0_xor_1(self):
        proc = Processor()
        code = [0x71, 0x77, 0x1e]
        proc.write_memory(0, code)
        proc.write_psw(0b10000000)
    ...
    # xor1 cy,psw.7               ;71 77 1e
    def test_71_77_xor_cy_psw_bit7_1_xor_1(self):
        proc = Processor()
        code = [0x71, 0x77, 0x1e]
        proc.write_memory(0, code)
    ...
    def test_88_20_add(self):
        ...
        code = [0x88, 0x20, 0x03]
        proc.write_memory(0, code)
        proc.memory[0xfe20] = 0x02
        proc.write_psw(Flags.Z | Flags.AC | Flags.CY)
        proc.step()
        self.assertEqual(proc.pc, len(code))
        self.assertEqual(proc.memory[0xfe20], 5) # sum
        self.assertEqual(proc.read_psw(), 0)
    ...
    def test_a8_20_addc_saddr(self):
        ...
        proc.step()
        self.assertEqual(proc.pc, len(code))
        self.assertEqual(proc.memory[0xfe20], 6) # sum
        self.assertEqual(proc.read_psw(), 0)

    # addc a,x                    ;61 28
    def test_61_28_addc_a_x(self):
        proc = Processor()
        code = [0x61, 0x28]
        proc.write_memory(0, code)
        proc.write_gp_reg(Registers.A, 2)
